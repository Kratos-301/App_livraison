...
//   console.log("✅ Données reçues pour commande :", req.body);
...
//         req.session.erreur = 'Commande déjà en cours ou en attente.';
//         return res.redirect('/commande/html/page/accueil');
//       }
//     }
...
//       if (err) {
//         req.session.erreur = 'Erreur serveur (livreur)';
//         return res.redirect('/commande/html/page/accueil');
//       }

//       const enCours = commandesLivreur.find(cmd => cmd.statut === 1 && cmd.statut_3 === 0 && cmd.disponibilite === 0);
//       if (enCours) {
//         req.session.erreurlivreuroccupe = 'Le livreur est déjà occupé avec une autre commande.';
//         return res.redirect('/commande/html/page/accueil');
//       }
...
//         if (err) {
//           req.session.erreur = 'Erreur lors de l’enregistrement';
//           return res.redirect('/commande/html/page/accueil');
//         }
...
//         io.emit('livreurOccupe', { livreurId: livreur_id });

//         req.session.succes = 'Commande envoyée avec succès';
//         return res.redirect('/commande/html/page/accueil');
//       });
//     });
//   });
...
//     if (err) return res.status(500).send('Erreur annulation');
...
//     req.session.succes = 'Commande annulée';
//     return res.redirect('/commande/html/page/accueil');
//   });
// };
...
//     io.to(`cmd_${id}`).emit('update', { id, type: 'annulation' });
//     req.session.succes = 'Commande annulée';
//     return res.redirect('/commande/html/page/acc-livreur');
//   });
// };
...
//     req.session.succes = 'Commande confirmée';
//     return res.redirect('/commande/html/page/acc-livreur');
//   });
// };
